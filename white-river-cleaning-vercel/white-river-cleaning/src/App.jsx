...
function Button({ children, variant = "solid", className = "" }) {
  return (
    <button className={`button ${variant === "outline" ? "buttonOutline" : ""} ${className}`}>
      {children}
    </button>
  );
}
...
export default function App() {
  ...
  const smsText = encodeURIComponent(
    `Hi White River Cleaning, my name is ${form.name || "___"}. I'm interested in ${form.service}. My phone number is ${form.phone || "___"}. Details: ${form.details || "___"}`
  );
      ...
      <section id="booking" className="bookingSection">
        <div className="twoCol">
          ...
          <Card className="formCard">
            ...
            <a href={`sms:8706130544?&body=${smsText}`}><Button>Text My Free Estimate Request</Button></a>
